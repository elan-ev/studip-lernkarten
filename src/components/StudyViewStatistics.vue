...
<template>
    <div class="">
        <div class="tw-flex tw-gap-2 tw-justify-between tw-items-baseline tw-text-sm">
            <span>
                <span class="">
            ...
            <span>
                Verbleibende Karten:
                <span class="tw-text-lg">{{ cardsLeft }}</span>
            </span>
        </div>
        <div class="tw-h-[1px] tw-bg-slate-300 tw-w-full" />
    </div>
</template>
